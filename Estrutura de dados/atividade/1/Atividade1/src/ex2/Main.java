...
public class Main {
	...
	public static void main(String[] args) {
		...
		//retorna a lista após a inserção
		...
		JOptionPane.showMessageDialog(null, "Temperaturas\n" + listaTemp);
		//retorna a lista após a remoção
		...
		if (elementoRemovido < -999) {
			...
			JOptionPane.showMessageDialog(null, elementoRemovido + "º foi removida do inicio da lista");
		}JOptionPane.showMessageDialog(null, "Temperaturas\n" + listaTemp);
		//retorna a lista após a remoção
		...
		if (elementoRemovido < -999) {
			...
			JOptionPane.showMessageDialog(null, elementoRemovido + "º foi removida do final da lista");
		}
		JOptionPane.showMessageDialog(null, "Temperaturas\n" + listaTemp);
		//retorna a lista após a remoção
		...
		while (opc != 9) {
			...
			opc = Integer.parseInt(JOptionPane.showInputDialog(
					"Escolha a opção desejada:\n "
							...
							+ "3-Adiciona no final\n"
							+ "4-Adiciona posição específica\n"
							+ "5-Remove no Inicio\n"
							+ "6-Remover no final\n"
							+ "7-Remover posição específica\n"
