...
public class ListaDeAlunos {
	...
	public void adicionaInicio(int ra, String nome, String turma, String semestre) {
		...
		if (inicio == null) {
			inicio = novo;
			JOptionPane.showMessageDialog(null, nome + " foi adicionado no início da lista");
			...
			inicio = novo;
			JOptionPane.showMessageDialog(null, nome + " foi adicionada no início da lista");
	...
	public String toString() {
		...
		if (inicio == null) {
			mostra = "A lista ainda não possui nenhum aluno.";
		} else {
