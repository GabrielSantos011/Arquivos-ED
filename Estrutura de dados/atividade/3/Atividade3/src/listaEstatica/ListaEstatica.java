...
public class ListaEstatica {
	...
	static Curso lista[] = new Curso[5];
	...
	public static void main(String[] args) {
		...
		while(opc!=10) {
			opc = Integer.parseInt(JOptionPane.showInputDialog("1 - verificar se a lista está vazia\n"
					...
					+ "3 - adicionar no início da lista\n"
					+ "4 - adicionar no final da lista\n"
					+ "5 - adicionar em determinada posição da lista\n"
					+ "6 - remover do início da lista\n"
					+ "7 - remover do final da lista\n"
					+ "8 - remover de determinada posição da lista\n"
	...
	public static void adicionaInicio() {
		if(listaCheia()==true) {
			...
			Curso add = new Curso();
			add.id = Integer.parseInt(JOptionPane.showInputDialog("Qual o id do curso?"));
			add.nome =JOptionPane.showInputDialog("Qual o curso?");
			add.area = JOptionPane.showInputDialog("Qual a área do curso?");
			add.quantidadeSemestres = Integer.parseInt(JOptionPane.showInputDialog("Quantos semestres?"));
			add.periodo = (JOptionPane.showInputDialog("Qual o período do curso?"));
			lista[0] = add;
			tamanho++;
		}
	...
	public static Curso removeInicio() {
	...
	public static Curso removeFinal() {
		Curso retorno= new Curso();
		if(listaVazia()==true) {
	...
	public static Curso removePosicao() {
	...
	public static String concatena(String tudo) {
		for(int i = 0; i<tamanho;i++) {
			...
			tudo+=lista[i].id+"\n";
			tudo+=lista[i].area+"\n";
			tudo+=lista[i].quantidadeSemestres+"\n";
			tudo+=lista[i].periodo+"\n\n\n";
		}
		return tudo;
	}
